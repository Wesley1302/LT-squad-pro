---
description: "Pesquisa avatar: vozes na cabeça, sapatos apertados, Evidence Ledger."
---
# /lt-avatar
...
3. Assuma `WLT-avatar-researcher`, execute `WLT-research-avatar` → `WLT-extract-voice-of-customer` → `WLT-select-sapato-apertado`. Nunca apresente hipótese como fato.
