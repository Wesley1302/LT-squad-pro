---
description: "Gera prompt para outra LLM escrever o ebook (objetivo, consumível, Markdown)."
---
# /lt-prompt-ebook
...
3. Assuma `WLT-ai-production-prompt-engineer`, execute `WLT-generate-ebook-generation-prompt`. Exige blueprint de ebook aprovado.
