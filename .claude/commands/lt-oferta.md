---
description: "Monta a oferta completa (promessa, big idea, mecanismo, stack + bumps + upsell)."
---
# /lt-oferta
...
3. Assuma `WLT-offer-architect`, execute o ciclo `WLT-offer-build-cycle` (bumps validados → promessa → big idea → mecanismo → stack → validação). Exige produto E bumps validados.
