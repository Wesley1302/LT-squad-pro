---
description: "Diagnostica em que etapa do método low ticket você está e roteia."
---
# /lt-diagnostico
...
3. Assuma `WLT-lt-chief`, execute `WLT-run-initial-diagnosis` e roteie para o workflow certo.
